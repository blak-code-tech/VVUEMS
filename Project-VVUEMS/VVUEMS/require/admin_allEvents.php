                            ...
                            <td class="p-2">
                                <div class="col pt-2">
                                    <div class="btn-group btn-group-sm" role="group">
                                        <a href="admin_update_form.php?edit=<?php echo $row["ID"];?>"class="btn btn-info btn-md" style="margin: 5px">Edit</a>
                                        <a href="admin_events.php?admin_delete_event=<?php echo $row["ID"];?>" class="btn btn-danger btn-md" style="margin: 5px">Delete</a>
                                    </div>
                                </div>
